...
/*
 *
 * $Id: sh1853.c,v 1.1 1994-04-21 12:10:42 boh Exp $
 *
 */
...
{            
  ...
  double *scyl = NULL;     /* Description of cylinder as implicit surface.*/
  ...
  *jtrack = 0;
  ...
  if ((scyl = newarray((idim+1)*(idim+1),double)) == NULL) goto err101;
