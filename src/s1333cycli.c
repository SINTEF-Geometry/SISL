...
/*
 *
 * $Id: s1333cycli.c,v 1.1 1994-04-21 12:10:42 boh Exp $
 *
 */
...
*********************************************************************
*                                                                   
* PURPOSE    : To describe the surface vsurf with a cyclic basis of continuity
*              icont in the first parameter direction.
*
