...
/*
 *
 * $Id: s1015.c,v 1.1 1994-04-21 12:10:42 boh Exp $
 *
 */
#define S1015
...
*              two curves. The center of the (circular) fillet is also
*              calculated.
*
* INPUT      : pc1    - The first input curve.   
*              pc2    - The second input curve.   
*              aepsge - Geometry resolution.         
*              eps1   - Point telling that the fillet should be put on 
*                       the side of curve 1 where eps1 is situated.
*              eps2   - Point telling that the fillet should be put on the 
...
*
* OUTPUT     : center - Center of the (circular) fillet.
*              status - Status:
*                              = 1      : converged
*                              = 2      : diverged
*                              < 0      : error
...
*/
{
  ...
  SISLPoint *p2;      /* SISLPoint form of eps2.                          */
